...
%>
							<tr height=30>
								<td class="ct"><%=j%></td>
								<td>&nbsp;<a href="beginner_w.asp?seq=<%=rs("seq")%>&<%=pageParam%>&page=<%=page%>"><%=rs("title")%></a></td>
								<td class="ct"><%=rs("gubn")%></td>
...
%>
				...
				<div id="btnarea1">
					<a href="beginner_w.asp" class="btn btn25"><span>글쓰기</span></a>
				</div>
			</div>
			<!-- admwrap1 E -->
		</div>
