...
<div id="wrap">
	<div id="mwrap2">
		<div id="poptitle2">
			<div>
				<font class="fc8">※ <b class="fce"><%=meminfo(uno,"uname")%></b> 님의 톡포인트 정보는 전체 <b class="fcr"><%=recordcount%></b> 건 입니다.</font>
			</div>
			<div class="rg">
			...
			<div style="border-bottom:1px solid #999;">
				<a href="point_p1.asp?uno=<%=uno%>"><img src="/img/box/ship_off.gif" title="쉽포인트" /></a><a href="point_p2.asp?uno=<%=uno%>"><img src="/img/box/talk_on.gif" title="톡포인트" /></a>
			</div>
...
<%		End If %>
			...
			<div id="btnarea1">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="point_p2.asp?uno=<%=uno%>" class="btn btn25"><span>새로고침</span></a>
			</div>
		</div>
		<!-- poptitle2 E -->
	</div>
