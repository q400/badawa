...
<%
	...
	End Function
	'https://www.badawa.co.kr/data/dld.asp?path=notice&file=250514145706[1]_800.jpg
	If op <> "pc" Then
...
%>
	...
	<div style="position:absolute; max-bottom:15%; z-index:300; background:#eee;" class="fleft">
		<div style="">
			<div id="menu" style="width:100%; margin-left:35px;">
...
%>
								...
								<td width="182" class="vt">
									...
									<span style="padding:0 0 50px 0;">MG새마을금고</br>9002-2090-5663-4 (양주영)</span>
								</td>
								<td width="35">&nbsp;</td>
...
<div class="popupLayer<%=j%>" onclick="popupLayerClose('popupLayer<%=j%>');"
style="display:none; z-index:9999999; position:absolute; top:<%=ttop%>px; left:<%=lleft%>px; border:1px solid #fff; background-color:#000;<%If title <> "제목없음" Then%>opacity:0.8; filter:alpha(opacity=70);"<%End If%>>
...
<%		End If %>
	...
	<tr>
		<td bgcolor="#dfdfdf">
			<a href="javascript:javascript:closeWin('pop<%=j%>',<%=j%>);" class="frt mb5 mr10">
			<img src="/img/icon/delete_2.gif" class="vm">&nbsp;&nbsp;<span class="fcw ff">오늘 하루 창을 열지 않습니다.</span>
			</a>
		</td>
	</tr>
</form>
...
<!-- #include virtual = "/inc/footer_main.asp" -->
