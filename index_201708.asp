...
<%
	...
	Function mobile_device_detect()
		...
		For i = 0 To Ubound(ArrBrowser)
			...
			If (InStr(sUserAgent, CompareAgent)) <> 0 Then
				isMobile = True
			End If
		Next
...
<div id="wrap" style="background:#eee;">
	<!-- Start photosgallery-std -->
	<div class="sliderkit photosgallery-std timer-demo01" style="top:-10px;">
		<div class="sliderkit-timer-wrapper">
			<div class="sliderkit-timer"></div>
		</div>
		<div class="sliderkit-panels">
			<div class="sliderkit-panel">
				<img src="/img/box/m11.jpg" alt="바다와" />
			</div>
			<div class="sliderkit-panel">
				<img src="/img/box/m02.jpg" alt="바다와" />
			</div>
			<div class="sliderkit-panel">
				<img src="/img/box/m03.jpg" alt="바다와" />
			</div>
			<div class="sliderkit-panel">
				<img src="/img/box/m04.jpg" alt="바다와" />
			</div>
			<!--
			<div class="sliderkit-panel">
			...
			//-->
			<div class="sliderkit-panel">
				<img src="/img/box/m05.jpg" alt="바다와" />
			</div>
			<div class="sliderkit-panel">
				<img src="/img/box/m06.jpg" alt="바다와" />
			</div>
			<div class="sliderkit-panel">
				<img src="/img/box/m07.jpg" alt="바다와" />
			</div>
			<div class="sliderkit-panel">
				<img src="/img/box/m08.jpg" alt="바다와" />
			</div>
		</div>
	</div>
...
%>
	...
	<div style="position:absolute;" class="fleft">
		<div id="menu" style="position:absolute; width:1100px; height:120px; left:35px; top:-30px;">
			<img src="/img/box/middle3.png" usemap="#map09">
			<map name="map09">
			<area shape="rect" coords="1, 10, 160, 110" style="cursor:pointer;" href="/rsv/" alt="낚시배예약">
			<area shape="rect" coords="170, 10, 350, 110" style="cursor:pointer;" href="/bbs2/gallery.asp" alt="조황갤러리">
			...
			<area shape="rect" coords="866, 17, 1015, 55" style="cursor:pointer;" href="http://forecasts.swellwatch.com/#place=22.755920681486405_139.21874999999997_3_1648_height_none_%uC704%uC131_-1" target="_blank" alt="미국기상정보">
...
%>
									<tr>
										<td class="f11 vt">
											...
											<a href="/bbs1/notice_v.asp?seq=<%=rs("seq")%>"><%=trimtext(rs("title"),17)%>&nbsp;&nbsp;<font class="fc1 ff f11 ls"><%=Left(rs("ddate"),10)%></font></a>
...
%>
									<tr>
										<td height="50" class="f11"><img src="/img/dot01.gif" width="4" height="3" class="vm">&nbsp;"공지사항이 없습니다."</td>
									</tr>
<%
	End If
	rsc()
...
%>
									<tr>
										<td class="f11 vt">
											<img src="/img/dot01.gif" width="4" height="3" class="vm">
											<a href="/bbs1/qna_v.asp?seq=<%=rs("seq")%>"><%=trimtext(rs("title"),17)%>&nbsp;&nbsp;<font class="fc1 ff f11 ls"><%=Left(rs("ddate"),10)%></font></a>
											<%If Date() - rs("ddate") < 2 Then%><img src="/img/icon/new03.gif" width="11" height="11"><%End If%>
										</td>
									</tr>
<%
...
%>
									<tr>
										<td height="50" class="f11"><img src="/img/dot01.gif" width="4" height="3" class="vm">&nbsp;"문의글이 없습니다."</td>
									</tr>
<%
	End If
	rsc()
%>
							...
							<td width="30">&nbsp;</td>
							<td width="182"><img src="/img/m_baner_bank.gif" width="182" height="99"></td>
							<td width="35">&nbsp;</td>
...
<%		End If %>
	...
	<tr height="20">
		<td bgcolor="#dfdfdf" class="rg">
			<a href="javascript:javascript:closeWin('pop<%=j%>',<%=j%>);"><img src="/img/icon/delete_2.gif" class="vm">&nbsp;&nbsp;<span class="fc1 ff f11">오늘 하루 창을 열지 않습니다.</span>&nbsp;</a>
		</td>
	</tr>
</form>
</table>
