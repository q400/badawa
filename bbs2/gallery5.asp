			...
			<li class="ib vt">
				<div id="mainwrap4">
					...
					<div style="width:810px; border:0px solid #000;" class="mb10">
						<ul>
							<li class="ct ib" style="width:100px; border:1px solid #ccc;" onClick="location='gallery5.asp'">전체</a></li>
<%
	rso()
	i = 0
	...
	While Not rs.eof
%>
							<li class="ct ib pt" style="width:100px; border:1px solid #ccc;" onClick="location='gallery5_v.asp?shipid=<%=rs("shipid")%>'"><%=rs("shipnm")%></a></li>
<%
		rs.MoveNext
		i = i + 1
	Wend
...
%>
						<div style="width:380px;" class="ib mt20 mr20">
							<span class="ib vt mr10"><a href="gallery5_v.asp?shipid=<%=rs("shipid")%>"><img src="<%=pphoto%>" width="150" class="gbox03" /></a></span>
										...
										<td height="24">
											<table width="200" border="0" cellspacing="0" cellpadding="0">
												<tr>
													...
													<td class="f12 fb fc9">
														<a href="gallery5_v.asp?shipid=<%=rs("shipid")%>"><%=rs("shipnm")%> / <font class="fc2 f11 ls"><%=wdate%></font></a>
