...
<%	If FID_NO = "" Then %>
	...
	this.document.location = "/mem/login.asp?preURL=/bbs2/gallery5_v.asp?shipid=<%=shipid%>&dt=<%=dt%>";
	return;
<%	End If %>
...
%>
							...
							onClick="location='gallery5_v.asp?shipid=<%=rs("shipid")%>'"><%=rs("shipnm")%></a></li>
<%
		rs.MoveNext
		i = i + 1
	Wend
							...
							<tr class="vt">
								<td width=340 rowspan="2">
									<table width=100% border="0" cellspacing="0" cellpadding="0" align="center">
										<tr height="40">
											<td class="ct vm" colspan="2"><span class="f25 fcb fb ls"><%=shipInfo(shipid,"shipnm")%></span></td>
										</tr>
										<tr>
											<td class="vt ct">
...
%>
							...
							<tr>
								<td class="ct">
									<table width="270" border="1" cellspacing="0" cellpadding="0" align="center" bordercolor="#ffffff" style="border-collapse:collapse;">
										<tr>
											<td class="ct">
												<table width=450 border="0" cellspacing="0" cellpadding="0" bordercolor="#ffffff" style="border-collapse:collapse;">
													<tr>
														<td width=90 class="ct"><u>날씨</u></td>
														<td width=90 class="ct"><u>파고</u></td>
														<td width=90 class="ct"><u>입질</u></td>
														<td width=90 class="ct"><u>조과</u></td>
														<td width=90 class="ct"><u>최대어종(크기)</u></td>
														<!--
														<td width=100 class="f11 ct"><img src="/img/bbs/weather.gif"></td>
														<td width=100 class="f11 ct"><img src="/img/bbs/pago.gif"></td>
														<td width=100 class="f11 ct"><img src="/img/bbs/ipzil.gif"></td>
														<td width=100 class="f11 ct"><img src="/img/bbs/jogwa.gif"></td>
														<td width=100 class="f11 ct"><img src="/img/bbs/fishsize.gif"></td>
														-->
													</tr>
													<tr height="30">
														<td class="ct"><%=weather%></td>
														<td class="ct"><%=pago%></td>
														<td class="ct"><%=ipzil%></td>
														<td class="ct"><%=jogwa%></td>
														<td class="ct"><%=bestfish%>(<%=fishsize%>)</td>
													</tr>
												</table>
											</td>
										</tr>
					...
					<div style="width:100%; height:120px; overflow-x:hidden; overflow-y:hidden;" class="mt10">
						<iframe src="gallery5_sub.asp?shipid=<%=shipid%>" frameborder=0 name="obj" style="width:100%; height:118px; background-color:#fff;"></iframe>
					</div>
...
<%	End If %>
					<div>
						...
						<a href="#" onClick="twitterOpen('<%=snsRoots%>/bbs1/gallery5_v.asp?shipid=<%=shipid%>&dt=<%=dt%>');return false;"><img alt="트위터에 공유하기" src="/img/icon/posttwit.png" /></a>
						<a href="#" onClick="facebookOut('<%=snsRoots%>/bbs1/gallery5_v.asp?shipid=<%=shipid%>&dt=<%=dt%>');return false;"><img alt="페이스북에 공유하기" src="/img/icon/postfb.png" /></a>
						<a href="#" onClick="me2DayOpen('<%=snsRoots%>/bbs1/gallery5_v.asp?shipid=<%=shipid%>&dt=<%=dt%>');return false;"><img alt="미투데이에 공유하기" src="/img/icon/postmeto.png" /></a>
						<a href="#" onClick="yozmOpen('<%=snsRoots%>/bbs1/gallery5_v.asp?shipid=<%=shipid%>&dt=<%=dt%>');return false;"><img alt="요즘에 공유하기" src="/img/icon/postyozm.png" /></a>
					</div>
					<div class="rg">
