...
<table width="250" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td width="106" height="75" class="ct vm" style="background-color:#cfcfcf;">
			<a href="gallery3_v.asp?shipid=<%=rs("shipid")%>&dt=<%=rs("wdate")%>" target="_top"><img src="<%=pphoto%>" width="100" /></a>
		</td>
		<td width="10"></td>
		<td width="134">
			<table width="130" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td style="padding-bottom:5px;" class="lf"><a href="gallery3_v.asp?shipid=<%=rs("shipid")%>&dt=<%=rs("wdate")%>" target="_top"><b class="ff f17 fc9 ls"><%=wdate%></b></a></td>
				</tr>
				<tr>
					<td>
						<a href="gallery3_v.asp?shipid=<%=shipid%>&dt=<%=rs("wdate")%>" target="_top"><b class="f15 ls2"><%=shipInfo(shipid, "shipnm")%> 조황</b></a>
						<br>
