...
<svg
    ...
    <script type="application/ecmascript" xlink:href="dextuploadx5-application.js"/>
    <script type="application/ecmascript"><![CDATA[/* 모든 애플리케이션 로직은 dextuploadx5-application.js 에 정의됩니다. */]]></script>
    <style type="text/css">
        ...
        * { box-sizing: border-box; }
        ...
        .css-item-op-run { fill: #00bff3; }
        .css-item.selected .css-item-op-run { fill: #fff; }
    ...
    <defs>
        ...
        <symbol id="UIS-ARRANGE-DESC" viewBox="0 0 8 8">
    ...
    <svg id="UIC-MAIN-AREA" x="0" y="0" width="100%" height="100%">
        ...
        <svg id="UIC-FILE-AREA" x="0" layout-dx5="y:{headerHeight}; width:100%-{vscrollbarWidth}; height:100%-{headerHeight}-{footerHeight};">
            <image id="UIC-BACKGROUND-IMG" xlink:href="" disableCacheExpression="disabled"/>
        </svg>
        <!-- scrollbar -->
        ...
        <svg id="UIC-HEADER" x="0" y="0" width="100%" layout-dx5="height:{headerHeight}" fill="#f7f7f7">
            ...
            <rect id="UIC-HEADER-BK-NAME" y="0" height="100%" layout-dx5="x:{checkerWidth};width:100%-30px-{sizeColumnWidth}-{checkerWidth}-{vscrollbarWidth};"/>
            <rect id="UIC-HEADER-BK-SIZE" y="0" height="100%" layout-dx5="x:100%-30px-{sizeColumnWidth}-{vscrollbarWidth}; width:{sizeColumnWidth};"/>
            <rect id="UIC-HEADER-BK-OP" y="0" width="30" height="100%" layout-dx5="x:100%-30px-{vscrollbarWidth};"/>
            <rect id="UIC-HEADER-BK-EMPTY" y="0" height="100%" layout-dx5="x:100%-{vscrollbarWidth}; width:{vscrollbarWidth};"/>

            <!--line id="UIC-HEADER-LN-CHECK" y1="0" y2="100%" layout-dx5="x1:{checkerWidth}; x2:{checkerWidth};" stroke="#d8d8d8" stroke-width="1"/-->
            <line id="UIC-HEADER-LN-SIZE" y1="0" y2="100%" layout-dx5="x1:100%-30px-{sizeColumnWidth}-{vscrollbarWidth}; x2:100%-30px-{sizeColumnWidth}-{vscrollbarWidth};" shape-rendering="crispEdges" stroke="#d8d8d8" stroke-width="1"/>
            <line id="UIC-HEADER-LN-OP" y1="0" y2="100%" layout-dx5="x1:100%-30px-{vscrollbarWidth}; x2:100%-30px-{vscrollbarWidth};" shape-rendering="crispEdges" stroke="#d8d8d8" stroke-width="1"/>
            ...
            <text id="UIC-HEADER-TXT-SIZE" class="css-header-font-name css-header-font-color" layout-dx5="x:100%-38px-{vscrollbarWidth}-{sizeSortButtonWidth}; y:{headerTextBaseline}" font-size="12px" font-weight="bold" text-anchor="end">Size</text>

            <g id="UIC-SORT-BUTTONS">
                <use id="UIC-SORT-BUTTON-NAME-ASC" xlink:href="#UIS-ARRANGE-ASC" width="8" height="8" layout-dx5="x:100%-30px-{sizeColumnWidth}-{vscrollbarWidth}-12px;y:50%-4px;" style="display:none;"/>
                <use id="UIC-SORT-BUTTON-NAME-DESC" xlink:href="#UIS-ARRANGE-DESC" width="8" height="8" layout-dx5="x:100%-30px-{sizeColumnWidth}-{vscrollbarWidth}-12px;y:50%-4px;" style="display:none;"/>
                <use id="UIC-SORT-BUTTON-SIZE-ASC" xlink:href="#UIS-ARRANGE-ASC" width="8" height="8" layout-dx5="x:100%-30px-{vscrollbarWidth}-12px;y:50%-4px;" style="display:none;"/>
                <use id="UIC-SORT-BUTTON-SIZE-DESC" xlink:href="#UIS-ARRANGE-DESC" width="8" height="8" layout-dx5="x:100%-30px-{vscrollbarWidth}-12px;y:50%-4px;" style="display:none;"/>
            </g>
        </svg>
        <!-- footer -->
