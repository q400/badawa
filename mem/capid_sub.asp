...
<!--
function zipselect(pid, pemail, ptel1, ptel2, ptel3, php1, php2, php3){
...
//	parent.parent.document.all.zip2.value = arrZipCode[1];
	...
	parent.parent.document.all.tel1.value = ptel1;
	parent.parent.document.all.tel2.value = ptel2;
	parent.parent.document.all.tel3.value = ptel3;
	...
	parent.parent.document.all.sz.focus();
...
%>
	...
	<tr height="23" align="center">
		<th><a style="cursor:hand" onClick="zipselect('<%=rs("memid")%>','<%=email%>','<%=tel1%>','<%=tel2%>','<%=tel3%>','<%=hp1%>','<%=hp2%>','<%=hp3%>')"><%=rs("memid")%></a></th>
		<td class="f12"><a style="cursor:hand" onClick="zipselect('<%=rs("memid")%>','<%=email%>','<%=tel1%>','<%=tel2%>','<%=tel3%>','<%=hp1%>','<%=hp2%>','<%=hp3%>')"><%=rs("uname")%> (<%=rs("unamee")%>)</a></td>
	</tr>
	<tr>
