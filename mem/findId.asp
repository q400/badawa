...
<input type="hidden" name="gubn" value="ID">
		...
		<ul>
			...
			<li class="ib vt">
				<div id="mainwrap1">
					...
					<div class="mt10 mb10">
						<img src="/img/memcnt_findid_tle.gif" alt="아이디찾기" title="아이디찾기" />
					</div>
					<div style="margin:50px 0px;"></div>
					<div class="ct"><img src="/img/login_cnt04.gif" alt="이름과 이메일을 입력하세요" /></div>
							...
							<table border=0 cellspacing="0" cellpadding="0" align="center">
								<tr>
									...
									<td width="100" rowspan="3">
										<a href="javascript:;" onClick="findId()"><img src="/img/btn_src01.gif" alt="찾기" title="찾기" /></a>
									</td>
								</tr>
								<tr>
									<td>이메일</td>
									<td><input type="text" name="userEmail" id="userEmail" maxlength="50" class="bx2" tabindex=2 style="width:150px;" onKeyDown="writeKeyDown();" /></td>
								</tr>
							</table>
						</div>
					</div>
					<div style="margin:30px 0px;"></div>
					<div class="ct"><img src="/img/login_cnt05.gif" alt="패스워드가 기억나지 않으시면 아래 버튼을 클릭하기 바랍니다" /></div>
